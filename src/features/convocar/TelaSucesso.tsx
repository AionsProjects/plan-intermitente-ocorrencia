      ...
      <div className="mt-8 flex flex-col items-stretch gap-3 sm:flex-row sm:justify-center">
        {!ehMock && itemUrl && (
          <a
            ...
            className="inline-flex items-center justify-center gap-2 rounded-2xl border border-white/15 bg-white/5 px-5 py-3 text-sm font-medium text-white/85 backdrop-blur transition hover:border-white/25 hover:bg-white/10"
          >
