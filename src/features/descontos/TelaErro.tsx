  ...
  return (
    <main className="relative z-10 flex min-h-svh items-center justify-center px-4 py-8">
      <div className="glass-strong w-full max-w-md p-10 text-center">
        ...
        <h1 className="text-display mt-5 text-3xl leading-tight text-white">
          {titulo}
        </h1>
        <p className="mt-3 text-sm text-white/65">{mensagem}</p>
        <Link
          to="/"
          className="mt-6 inline-flex items-center gap-1.5 text-xs text-white/55 transition hover:text-white/85"
        >
          ← Voltar ao Hub
        </Link>
      </div>
