...
export type Scheme = "aurora" | "seco" | "verde" | "rosa" | "rubi" | "roxo" | "campo"
...
const SCHEMES: Scheme[] = ["aurora", "seco", "verde", "rosa", "rubi", "roxo", "campo"]
...
> = {
  ...
  campo: { label: "Campo", tones: ["#1a1a1a", "#4ade80", "#a3e635"] },
}
